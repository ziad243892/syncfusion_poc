...
(function(Input2) {
  ...
  function bindInitialEvent(args) {
    ...
    args.element.__eventHandlers.inputFocusHandler = focusHandler2;
    args.element.__eventHandlers.inputBlurHandler = blurHandler2;
    args.element.__eventHandlers.inputHandler = inputHandler2;
  }
    ...
    if (!isNullOrUndefined(args.element)) {
      if (!isNullOrUndefined(args.element.__eventHandlers)) {
        if (!isNullOrUndefined(args.element.__eventHandlers.inputFocusHandler) && !isNullOrUndefined(args.element.__eventHandlers.inputBlurHandler) && !isNullOrUndefined(args.element.__eventHandlers.inputHandler)) {
          var focusHandler_1 = args.element.__eventHandlers.inputFocusHandler;
          var blurHandler_1 = args.element.__eventHandlers.inputBlurHandler;
          var inputHandler_1 = args.element.__eventHandlers.inputHandler;
          ...
          args.element.__eventHandlers.inputFocusHandler = null;
          args.element.__eventHandlers.inputBlurHandler = null;
          args.element.__eventHandlers.inputHandler = null;
        }
      }
    }
  }
  ...
  function unWireFloatLabelEvents(args) {
    if (!isNullOrUndefined(args.element) && !isNullOrUndefined(args.element.__eventHandlers) && !isNullOrUndefined(args.element.__eventHandlers.floatInputHandler) && !isNullOrUndefined(args.element.__eventHandlers.floatBlurHandler)) {
      var inputFloatHandler = args.element.__eventHandlers.floatInputHandler;
      var blurFloatHandler = args.element.__eventHandlers.floatBlurHandler;
      args.element.removeEventListener("input", inputFloatHandler);
      args.element.removeEventListener("blur", blurFloatHandler);
      args.element.__eventHandlers.floatInputHandler = null;
      args.element.__eventHandlers.floatBlurHandler = null;
    }
  }
  ...
  function unWireClearBtnEvents(element, button) {
    if (!isNullOrUndefined(element) && !isNullOrUndefined(element.__eventHandlers)) {
      if (!isNullOrUndefined(element.__eventHandlers.clearClickHandler)) {
        var clickHandlerEvent = element.__eventHandlers.clearClickHandler;
        if (isBindClearAction === void 0 || isBindClearAction) {
          if (!isNullOrUndefined(button)) {
            button.removeEventListener("click", clickHandlerEvent);
          }
        }
        element.__eventHandlers.clearClickHandler = null;
      }
      if (!isNullOrUndefined(element.__eventHandlers.clearInputHandler) && !isNullOrUndefined(element.__eventHandlers.clearFocusHandler) && !isNullOrUndefined(element.__eventHandlers.clearBlurHandler)) {
        var inputHandlerEvent = element.__eventHandlers.clearInputHandler;
        var focusHandlerEvent = element.__eventHandlers.clearFocusHandler;
        var blurHandlerEvent = element.__eventHandlers.clearBlurHandler;
        ...
        element.__eventHandlers.clearInputHandler = null;
        element.__eventHandlers.clearFocusHandler = null;
        element.__eventHandlers.clearBlurHandler = null;
      }
    }
  }
  ...
  function decodeHtmlEntities(str) {
    var entityMap = {
      ...
      "&gt;": ">",
      "&eacute;": "é"
      // tslint:disable-line:comma-dangle
    };
    return str.replace(/&[a-zA-Z#0-9]+;/g, function(entity) {
  ...
  function setPlaceholder(placeholder, element, moduleName) {
    var modules = [
      "textbox",
      "numerictextbox",
      "textarea",
...
var NumericTextBox = (
  ...
  (function(_super) {
    ...
    NumericTextBox2.prototype.updatePrependTemplate = function() {
      this.removePrependTemplate();
      this.createPrependTemplate();
    };
    NumericTextBox2.prototype.updateAppendTemplate = function() {
      this.removeAppendTemplate();
      this.createAppendTemplate();
    };
    NumericTextBox2.prototype.templateComplier = function(iconTemplate) {
      if (iconTemplate) {
        try {
    ...
    NumericTextBox2.prototype.createPrependTemplate = function() {
    ...
    NumericTextBox2.prototype.createAppendTemplate = function() {
    ...
    NumericTextBox2.prototype.handleFloatLabel = function() {
    ...
    NumericTextBox2.prototype.removePrependTemplate = function() {
      if (!isNullOrUndefined(this.prependedElement)) {
        detach(this.prependedElement);
        this.prependedElement = null;
      }
    };
    NumericTextBox2.prototype.removeAppendTemplate = function() {
    ...
    NumericTextBox2.prototype.inputHandler = function(event) {
      ...
      if (this.isAngular && this.element.value !== getValue("decimal", getNumericObject(this.locale)) && this.element.value !== getValue("minusSign", getNumericObject(this.locale)) && this.numericRegex().test(this.element.value)) {
    ...
    NumericTextBox2.prototype.getRightIconsWidth = function() {
    ...
    NumericTextBox2.prototype.updateFloatLabelOverflowWidth = function() {
      var container = this.inputWrapper.container;
    ...
    __decorate([
      Property(true)
    ], NumericTextBox2.prototype, "allowMouseWheel", void 0);
    __decorate([
      Property("Never")
    ], NumericTextBox2.prototype, "floatLabelType", void 0);
    __decorate([
      Property(null)
    ], NumericTextBox2.prototype, "prependTemplate", void 0);
    __decorate([
      Property(null)
    ], NumericTextBox2.prototype, "appendTemplate", void 0);
    __decorate([
      Event()
...
var MaskedTextBox = (
  ...
  (function(_super) {
    ...
    MaskedTextBox2.prototype.updatePrependTemplate = function() {
      this.removePrependTemplate();
      this.createPrependTemplate();
    };
    MaskedTextBox2.prototype.updateAppendTemplate = function() {
      this.removeAppendTemplate();
      this.createAppendTemplate();
    };
    MaskedTextBox2.prototype.templateComplier = function(iconTemplate) {
      if (iconTemplate) {
        try {
          if (typeof iconTemplate !== "function" && selectAll(iconTemplate, document).length) {
            return compile(select(iconTemplate, document).innerHTML.trim());
    ...
    MaskedTextBox2.prototype.createPrependTemplate = function() {
      if (!isNullOrUndefined(this.prependTemplate)) {
    ...
    MaskedTextBox2.prototype.createAppendTemplate = function() {
      if (!isNullOrUndefined(this.appendTemplate)) {
        var container = this.inputObj.container;
        this.appendedElement = this.createElement("div", { className: "e-append-template" });
        this.iconTemplateFunction = this.templateComplier(this.appendTemplate);
    ...
    MaskedTextBox2.prototype.handleFloatLabel = function() {
      var floatLabelElement = this.inputObj.container.querySelector(".e-float-text");
      if (floatLabelElement && this.floatLabelType === "Auto") {
        setTimeout(function() {
          if (floatLabelElement && this.prependedElement && !this.enableRtl) {
    ...
    MaskedTextBox2.prototype.removePrependTemplate = function() {
      if (!isNullOrUndefined(this.prependedElement)) {
        detach(this.prependedElement);
        this.prependedElement = null;
      }
    };
    MaskedTextBox2.prototype.removeAppendTemplate = function() {
      if (!isNullOrUndefined(this.appendedElement)) {
        detach(this.appendedElement);
        this.appendedElement = null;
      }
    ...
    MaskedTextBox2.prototype.getRightIconsWidth = function() {
      var container = this.inputObj.container;
      var width = 0;
      var iconSelectors = ".e-input-group-icon, .e-clear-icon";
      var icons = container.querySelectorAll(iconSelectors);
    ...
    MaskedTextBox2.prototype.updateFloatLabelOverflowWidth = function() {
      var container = this.inputObj.container;
      var label = container.querySelector(".e-float-text-overflow") || container.querySelector(".e-float-text");
      var calculateWidth = container.clientWidth - this.getRightIconsWidth();
      if (label && calculateWidth && !(this.cssClass && this.cssClass.split(" ").indexOf("e-outline") !== -1)) {
    ...
    __decorate2([
      Property(null)
    ], MaskedTextBox2.prototype, "prependTemplate", void 0);
    __decorate2([
      Property(null)
    ], MaskedTextBox2.prototype, "appendTemplate", void 0);
    __decorate2([
      Event()
...
var Slider = (
  ...
  (function(_super) {
    ...
    Slider2.prototype.secureRandom = function() {
    ...
    Slider2.prototype.initRender = function() {
      ...
      this.hiddenInput = this.createElement("input", {
        attrs: {
          ...
          name: this.element.getAttribute("name") || this.element.getAttribute("id") || "_" + (this.secureRandom() * 1e3).toFixed(0) + "slider",
    ...
    Slider2.prototype.setAriaAttributes = function(element) {
      ...
      if (this.type !== "Range") {
        ...
        var range = !isNullOrUndefined(this.customValues) && this.customValues.length > 0 ? [[!isNullOrUndefined(min) ? min.toString() : "", this.value.length > 1 && !isNullOrUndefined(this.customValues[this.value[1]]) ? this.customValues[this.value[1]].toString() : ""], [this.value.length > 0 && !isNullOrUndefined(this.customValues[this.value[0]]) ? this.customValues[this.value[0]].toString() : "", !isNullOrUndefined(max) ? max.toString() : ""]] : [
          [
            !isNullOrUndefined(min) ? min.toString() : "",
            this.value.length > 1 && !isNullOrUndefined(this.value[1]) ? this.value[1].toString() : ""
          ],
          [
    ...
    Slider2.prototype.changeHandleValue = function(value, args) {
      var position = null;
      if (this.activeHandle === 1) {
...
var Uploader = (
  ...
  (function(_super) {
    ...
    Uploader2.prototype.removeFilesData = function(file, customTemplate) {
      ...
      this.element.value = "";
      var iconElement = selectedElement.querySelector(".e-icons");
      if (iconElement) {
    ...
    Uploader2.prototype.clearData = function(singleUpload) {
      if (!isNullOrUndefined(this.listParent)) {
        var fileItems = this.listParent.querySelectorAll(".e-icons");
        for (var i = 0; i < fileItems.length; i++) {
          EventHandler.remove(fileItems[i], "click", this.removeFiles);
        }
        detach(this.listParent);
        this.listParent = null;
      }
        ...
        if (metaData.file.statusCode === "5") {
          ...
          this.trigger("canceling", eventArgs_1, function(eventArgs2) {
            if (eventArgs2.cancel) {
              ...
              ajax_2.beforeSend = function(e2) {
                if (Array.isArray(eventArgs2.currentRequest)) {
                  _this.updateCustomheader(ajax_2.httpRequest, eventArgs2.currentRequest);
                }
              };
              ajax_2.onLoad = function(e2) {
...
var DropDownMenuAnimationSettings = (
  /** @class */
  (function(_super) {
    __extends7(DropDownMenuAnimationSettings2, _super);
...
var DropDownButton = (
  ...
  (function(_super) {
    ...
    DropDownButton2.prototype.animatePopup = function(animationOptions, element) {
...
var SplitButton = (
  /** @class */
  (function(_super) {
    __extends8(SplitButton2, _super);
    ...
    SplitButton2.prototype.initWrapper = function() {
      ...
      if (this.enableRtl) {
        this.wrapper.classList.add(RTL2);
      }
      if (this.cssClass) {
        ...
        switch (prop) {
          ...
          case "enableRtl":
            if (newProp.enableRtl) {
              addClass([this.wrapper], RTL2);
            } else {
              removeClass([this.wrapper], RTL2);
            }
            break;
          case "disabled":
            if (newProp.disabled) {
...
var SpinSettings = (
  /** @class */
  (function(_super) {
    __extends9(SpinSettings2, _super);
...
var ProgressButton = (
  /** @class */
  (function(_super) {
    __extends9(ProgressButton2, _super);
...
var ColorPicker = (
  /** @class */
  (function(_super) {
    __extends10(ColorPicker2, _super);
    ...
    ColorPicker2.prototype.createSplitBtn = function() {
      ...
      if (this.isAngular) {
        this.splitBtn.isAngular = this.isAngular;
      }
        ...
        _this.trigger("beforeOpen", args, function(observeOpenArgs) {
          if (!observeOpenArgs.cancel) {
            ...
            if (Browser.isDevice) {
              ...
              appendToElement.insertBefore(_this.modal, popupEle);
    ...
    ColorPicker2.prototype.getAppendToElement = function() {
      if (this.isAngular) {
        var cdkPane = this.element.closest(".cdk-overlay-pane");
        var popoverEl = this.element.closest("[popover]");
        if (cdkPane && popoverEl) {
    ...
    ColorPicker2.prototype.paletteKeyDown = function(e) {
      ...
      switch (!e.altKey && e.keyCode) {
        case 39:
          e.preventDefault();
          if (prevSelectedEle && (!this.enableRtl && tiles.indexOf(prevSelectedEle) === tiles.length - 1 || this.enableRtl && tiles.indexOf(prevSelectedEle) === 0)) {
            idx = this.enableRtl ? tiles.length - 1 : 0;
          } else {
            idx = prevSelectedEle ? this.tilePosition(tiles, prevSelectedEle, this.enableRtl ? -1 : 1) : this.enableRtl ? tiles.length - 1 : 0;
          }
          if (tiles[idx]) {
        ...
        case 37:
          e.preventDefault();
          if (prevSelectedEle && (!this.enableRtl && tiles.indexOf(prevSelectedEle) === 0 || this.enableRtl && tiles.indexOf(prevSelectedEle) === tiles.length - 1)) {
            idx = this.enableRtl ? 0 : tiles.length - 1;
          } else {
            idx = prevSelectedEle ? this.tilePosition(tiles, prevSelectedEle, this.enableRtl ? 1 : -1) : this.enableRtl ? 0 : tiles.length - 1;
          }
          if (tiles[idx]) {
            selectedEle = tiles[idx];
          }
...
var TextBox = (
  ...
  (function(_super) {
    ...
    TextBox2.prototype.updatePrependTemplate = function() {
      this.removePrependTemplate();
      this.createPrependTemplate();
    };
    TextBox2.prototype.updateAppendTemplate = function() {
      this.removeAppendTemplate();
      this.createAppendTemplate();
    };
    TextBox2.prototype.templateComplier = function(iconTemplate) {
      if (iconTemplate) {
        try {
          if (typeof iconTemplate !== "function" && selectAll(iconTemplate, document).length) {
            return compile(select(iconTemplate, document).innerHTML.trim());
    ...
    TextBox2.prototype.createPrependTemplate = function() {
      if (!isNullOrUndefined(this.prependTemplate)) {
    ...
    TextBox2.prototype.createAppendTemplate = function() {
      if (!isNullOrUndefined(this.appendTemplate)) {
        var container = this.textboxWrapper.container;
        this.appendedElement = this.createElement("div", { className: "e-append-template" });
        this.iconTemplateFunction = this.templateComplier(this.appendTemplate);
    ...
    TextBox2.prototype.handleFloatLabel = function() {
    ...
    TextBox2.prototype.removePrependTemplate = function() {
      if (!isNullOrUndefined(this.prependedElement)) {
        detach(this.prependedElement);
        this.prependedElement = null;
      }
    };
    TextBox2.prototype.removeAppendTemplate = function() {
      if (!isNullOrUndefined(this.appendedElement)) {
        detach(this.appendedElement);
        this.appendedElement = null;
      }
    ...
    __decorate11([
      Property(null)
    ], TextBox2.prototype, "prependTemplate", void 0);
    __decorate11([
      Property(null)
    ], TextBox2.prototype, "appendTemplate", void 0);
    __decorate11([
      Event()
...
var TextArea = (
  ...
  (function(_super) {
    ...
    TextArea2.prototype.updatePrependTemplate = function() {
      this.removePrependTemplate();
      this.createPrependTemplate();
    };
    TextArea2.prototype.updateAppendTemplate = function() {
      this.removeAppendTemplate();
      this.createAppendTemplate();
    };
    TextArea2.prototype.templateComplier = function(iconTemplate) {
      if (iconTemplate) {
        try {
          if (typeof iconTemplate !== "function" && selectAll(iconTemplate, document).length) {
            return compile(select(iconTemplate, document).innerHTML.trim());
    ...
    TextArea2.prototype.createPrependTemplate = function() {
      if (!isNullOrUndefined(this.prependTemplate)) {
    ...
    TextArea2.prototype.createAppendTemplate = function() {
      if (!isNullOrUndefined(this.appendTemplate)) {
        var container = this.textareaWrapper.container;
        this.appendedElement = this.createElement("div", { className: "e-append-template" });
    ...
    TextArea2.prototype.handleAdornmentDirection = function(isPropertyChange) {
    ...
    TextArea2.prototype.handleAdornmentFloatLabel = function() {
      var floatLabelElement = this.textareaWrapper.container.querySelector(".e-float-text");
      if (floatLabelElement && this.floatLabelType === "Auto") {
        setTimeout(function() {
    ...
    TextArea2.prototype.removePrependTemplate = function() {
      if (!isNullOrUndefined(this.prependedElement)) {
        detach(this.prependedElement);
        this.prependedElement = null;
      }
    };
    TextArea2.prototype.removeAppendTemplate = function() {
      if (!isNullOrUndefined(this.appendedElement)) {
        detach(this.appendedElement);
        this.appendedElement = null;
      }
    ...
    TextArea2.prototype.focusHandler = function(args) {
      ...
      if (this.floatLabelType === "Auto" && (this.prependTemplate || this.appendTemplate)) {
        setTimeout(function() {
          var label2 = this.textareaWrapper ? this.textareaWrapper.container.querySelector(".e-float-text") : null;
          if (label2) {
            label2.style.width = "auto";
          }
        }.bind(this), 5);
      }
    };
    ...
    TextArea2.prototype.getRightIconsWidth = function() {
      var container = this.textareaWrapper.container;
      var width = 0;
      var iconSelectors = ".e-input-group-icon, .e-clear-icon";
      var icons = container.querySelectorAll(iconSelectors);
    ...
    TextArea2.prototype.updateFloatLabelOverflowWidth = function() {
      var container = this.textareaWrapper.container;
      var label = container.querySelector(".e-float-text-overflow") || container.querySelector(".e-float-text");
      var calculateWidth = container.clientWidth - this.getRightIconsWidth();
      if (label && calculateWidth && !(this.cssClass && this.cssClass.split(" ").indexOf("e-outline") !== -1) && (!this.prependTemplate || !this.appendTemplate)) {
        ...
        setTimeout(function() {
          var label2 = container ? container.querySelector(".e-float-text.e-label-bottom") : null;
          if (label2) {
            label2.style.width = this.element.offsetWidth + "px";
          }
        }.bind(this), 10);
      }
    };
    ...
    __decorate12([
      Property(null)
    ], TextArea2.prototype, "prependTemplate", void 0);
    __decorate12([
      Property(null)
    ], TextArea2.prototype, "appendTemplate", void 0);
    __decorate12([
      Property("Horizontal")
    ], TextArea2.prototype, "adornmentFlow", void 0);
    __decorate12([
      Property("Horizontal")
    ], TextArea2.prototype, "adornmentOrientation", void 0);
    __decorate12([
      Event()
...
var CaretPositionHelper = (
  ...
  (function() {
    ...
    CaretPositionHelper2.adjustScrollToCaretPosition = function(element) {
    ...
    CaretPositionHelper2.getTextAreaPosition = function(element) {
    ...
    CaretPositionHelper2.insertCharacter = function(element, text) {
...
var SmartTextArea = (
  /** @class */
  (function(_super) {
    __extends13(SmartTextArea2, _super);
    function SmartTextArea2(options, element) {
      return _super.call(this, options, element) || this;
    }
    SmartTextArea2.prototype.render = function() {
      ...
      this.suggestionDisplay = this.shouldShowInlineSuggestions(this.textArea) ? new InlineSuggestion(this, smartTextArea, this.textArea) : new ContextSuggestion(this, smartTextArea, this.textArea);
    };
    ...
    __decorate13([
      Event()
    ], SmartTextArea2.prototype, "beforeSuggestionInsert", void 0);
    __decorate13([
      Event()
    ], SmartTextArea2.prototype, "afterSuggestionInsert", void 0);
    __decorate13([
      Property("")
...
var InlineSuggestion = (
  /** @class */
  (function() {
    function InlineSuggestion2(smartTextArea, container, textArea) {
...
var ContextSuggestion = (
  /** @class */
  (function() {
    function ContextSuggestion2(smartTextArea, container, textArea) {
      var _this = this;
      this.latestSuggestionText = "";
      this.showing = false;
      this.smartTextArea = smartTextArea;
...
var SignatureBase = (
  /** @class */
  (function(_super) {
    __extends14(SignatureBase2, _super);
      ...
      for (var _i = 0, _a = Object.keys(newProp); _i < _a.length; _i++) {
        ...
        switch (prop) {
          ...
          case "allowReset":
            ...
            break;
          case "enableRtl":
            this.wrapper.classList[this.enableRtl ? "add" : "remove"](RTL4);
            break;
          case "cssClass":
            if (oldProp.cssClass) {
              removeClass([this.wrapper], oldProp.cssClass.split(" "));
      ...
      for (var _i = 0, _a = Object.keys(newProp); _i < _a.length; _i++) {
        ...
        switch (prop) {
          ...
          case "length":
            ...
            break;
          case "enableRtl":
            this.element.classList[this.enableRtl ? "add" : "remove"](RTL5);
            break;
          case "autoFocus":
            if (this.autoFocus) {
              this.focusIn();
...
var ButtonSettings = (
  /** @class */
  (function(_super) {
    __extends18(ButtonSettings2, _super);
...
var TooltipSettings = (
  /** @class */
  (function(_super) {
    __extends18(TooltipSettings2, _super);
...
var SpeechToText = (
  /** @class */
  (function(_super) {
    __extends18(SpeechToText2, _super);
    function SpeechToText2(options, element) {
      var _this = _super.call(this, options, element) || this;
...
//# sourceMappingURL=chunk-BVU7BQFE.js.map
