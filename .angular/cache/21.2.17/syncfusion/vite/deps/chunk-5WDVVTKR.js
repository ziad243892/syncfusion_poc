...
var Query = (
  ...
  (function() {
    ...
    Query2.prototype.sortByForeignKey = function(fieldName, comparer, isFromGroup, direction, foreignKeyValue) {
  ...
  (function() {
    ...
    DataUtil2.fnOperators = {
      ...
      isempty: function(actual) {
        return actual === void 0 || actual === "" || actual === null;
      },
      /**
    ...
    JsonAdaptor2.prototype.lazyLoadGroup = function(args) {
      ...
      if (!isNullOrUndefined(args.lazyLoad.onDemandGroupInfo)) {
        ...
        for (var i = 0; i < result.length; i++) {
          result[parseInt(i.toString(), 10)].startIndex = startIndex;
          startIndex += result[parseInt(i.toString(), 10)].count;
        }
        if (args.page) {
  ...
  (function(_super) {
      ...
      for (var i = 0; i < queries.sorts.length; i++) {
        ...
        if (!isNullOrUndefined(queries.sorts[i].e.foreignKeyValue)) {
          request.sorts.push(DataUtil.callAdaptorFunction(this, "onEachSort", {
            name: temp,
            comparer: queries.sorts[i].e.comparer,
            foreignKeyValue: queries.sorts[i].e.foreignKeyValue,
    ...
    UrlAdaptor2.prototype.getRequestQuery = function(options, query, singles, request, request1) {
      ...
      if (options.apply && query.distincts.length) {
        req[options.apply] = "";
        var applyQuery = "";
        if (moduleName && moduleName() === "ODataV4Adaptor" && (request.filters && request.filters.length || request.searches && request.searches.length)) {
          var where = DataUtil.callAdaptorFunction(this, "onWhere", request.filters, query);
      ...
      if (!(options.apply && query.distincts.length && moduleName && moduleName() === "ODataV4Adaptor" && (request.filters && request.filters.length || request.searches && request.searches.length))) {
...
var RemoteSaveAdaptor = (
  ...
  (function(_super) {
    ...
    RemoteSaveAdaptor2.prototype.getModuleName = function() {
...
var DataManager = (
  /** @class */
  (function() {
    function DataManager2(dataSource, query, adaptor, middlewares) {
      var _this = this;
      this.dateParse = true;
        ...
        promise.then(function(response) {
          ...
          fetch_2.onSuccess = function(data, request) {
            ...
            _this.afterReponseRequest(data).then(function(responseData) {
              ...
              return _this.dataManagerFailure(e, deff_1, {});
            });
          };
    ...
    DataManager2.prototype.clearCache = function() {
      if (this.isEnableCache) {
        window.localStorage.setItem(this.guidId, JSON.stringify({ keys: [], results: [] }));
      }
      if (this.dataSource && this.dataSource.enableCaching && this.adaptor && this.adaptor.guidId) {
        window.localStorage.setItem(this.adaptor.guidId, JSON.stringify({ keys: [], results: [] }));
      }
    };
    return DataManager2;
  })()
...
//# sourceMappingURL=chunk-5WDVVTKR.js.map
