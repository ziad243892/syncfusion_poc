...
var _c3 = ["legendSettingsTemplate"];
var _c4 = ["tooltipSankeyNodeTemplate"];
var _c5 = ["tooltipSankeyLinkTemplate"];
var input$A = ["accessibility", "animation", "backwardForecast", "dashArray", "enableTooltip", "fill", "forwardForecast", "intercept", "legendShape", "linearGradient", "marker", "name", "period", "polynomialOrder", "radialGradient", "type", "visible", "width"];
var outputs$K = [];
...
var input$z = ["color", "dashArray", "value"];
var outputs$J = [];
...
SeriesDirective.ɵdir = ɵɵdefineDirective({
  ...
  contentQueries: function SeriesDirective_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
      ɵɵcontentQuery(dirIndex, _c0, 5)(dirIndex, TrendlinesDirective, 5)(dirIndex, SegmentsDirective, 5);
    }
    if (rf & 2) {
      let _t;
...
var input$x = ["border", "color", "dashArray", "end", "horizontalAlignment", "imageUrl", "isRepeat", "isSegmented", "opacity", "repeatEvery", "repeatUntil", "rotation", "segmentAxisName", "segmentEnd", "segmentStart", "size", "sizeType", "start", "startFromAxis", "text", "textStyle", "verticalAlignment", "visible", "zIndex"];
var outputs$H = [];
...
var input$w = ["customAttributes", "end", "maximumTextWidth", "start", "text", "type"];
var outputs$G = [];
...
var input$v = ["alignment", "border", "categories", "overflow", "textStyle"];
var outputs$F = [];
...
AxisDirective.ɵdir = ɵɵdefineDirective({
  ...
  contentQueries: function AxisDirective_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
      ɵɵcontentQuery(dirIndex, StripLinesDirective, 5)(dirIndex, MultiLevelLabelsDirective, 5);
    }
    if (rf & 2) {
      let _t;
...
var input$r = ["colors", "end", "label", "start"];
var outputs$B = [];
...
var input$q = ["accessibility", "content", "coordinateUnits", "description", "horizontalAlignment", "region", "verticalAlignment", "x", "xAxisName", "y", "yAxisName"];
var outputs$A = [];
...
ChartComponent.ɵcmp = ɵɵdefineComponent({
  ...
  contentQueries: function ChartComponent_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
      ɵɵcontentQuery(dirIndex, _c2, 5)(dirIndex, _c3, 5)(dirIndex, SeriesCollectionDirective, 5)(dirIndex, AxesDirective, 5)(dirIndex, RowsDirective, 5)(dirIndex, ColumnsDirective, 5)(dirIndex, RangeColorSettingsDirective, 5)(dirIndex, AnnotationsDirective, 5)(dirIndex, SelectedDataIndexesDirective, 5)(dirIndex, IndicatorsDirective, 5);
    }
    if (rf & 2) {
      let _t;
      ɵɵqueryRefresh(_t = ɵɵloadQuery()) && (ctx.tooltip_template = _t.first);
      ɵɵqueryRefresh(_t = ɵɵloadQuery()) && (ctx.legendSettings_template = _t.first);
...
__decorate([Template()], ChartComponent.prototype, "legendSettings_template", void 0);
...
var LastValueLabelService = {
  provide: "ChartsLastValueLabel",
  useValue: LastValueLabel
};
var SeriesLabelService = {
  provide: "ChartsSeriesLabel",
  useValue: SeriesLabel
};
...
var input$m = ["content", "coordinateUnits", "description", "horizontalAlignment", "region", "verticalAlignment", "x", "y"];
var outputs$v = [];
...
AccumulationChartComponent.ɵcmp = ɵɵdefineComponent({
  ...
  contentQueries: function AccumulationChartComponent_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
      ɵɵcontentQuery(dirIndex, _c2, 5)(dirIndex, _c3, 5)(dirIndex, AccumulationSeriesCollectionDirective, 5)(dirIndex, AccumulationAnnotationsDirective, 5);
    }
    if (rf & 2) {
      let _t;
      ɵɵqueryRefresh(_t = ɵɵloadQuery()) && (ctx.tooltip_template = _t.first);
...
__decorate([Template()], AccumulationChartComponent.prototype, "legendSettings_template", void 0);
...
var input$l = ["animation", "border", "dashArray", "dataSource", "fill", "opacity", "query", "type", "width", "xName", "yName"];
var outputs$t = [];
...
RangeNavigatorComponent.ɵcmp = ɵɵdefineComponent({
  ...
  contentQueries: function RangeNavigatorComponent_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
      ɵɵcontentQuery(dirIndex, _c2, 5)(dirIndex, RangenavigatorSeriesCollectionDirective, 5);
    }
    if (rf & 2) {
      let _t;
      ɵɵqueryRefresh(_t = ɵɵloadQuery()) && (ctx.tooltip_template = _t.first);
...
var input$k = ["color", "endRange", "opacity", "startRange"];
var outputs$r = [];
...
var inputs$6 = ["axisSettings", "border", "containerArea", "dataLabelSettings", "dataSource", "enablePersistence", "enableRtl", "endPointColor", "fill", "format", "height", "highPointColor", "lineWidth", "locale", "lowPointColor", "markerSettings", "negativePointColor", "opacity", "padding", "palette", "query", "rangeBandSettings", "rangePadding", "startPointColor", "theme", "tiePointColor", "tooltipSettings", "type", "useGroupingSeparator", "valueType", "width", "xName", "yName"];
var outputs$q = ["axisRendering", "dataLabelRendering", "load", "loaded", "markerRendering", "pointRegionMouseClick", "pointRegionMouseMove", "pointRendering", "resize", "seriesRendering", "sparklineMouseClick", "sparklineMouseMove", "tooltipInitialize"];
var twoWays$6 = [""];
...
var input$j = ["animationDuration", "dataSource", "enableAnimation", "enableSmartLabels", "fill", "marker", "name", "opacity", "points", "reactance", "resistance", "tooltip", "tooltipMappingName", "visibility", "width"];
var outputs$p = [];
...
var inputs$5 = ["background", "border", "elementSpacing", "enablePersistence", "enableRtl", "font", "height", "horizontalAxis", "legendSettings", "locale", "margin", "radialAxis", "radius", "renderType", "series", "theme", "title", "width"];
var outputs$o = ["animationComplete", "axisLabelRender", "beforePrint", "legendRender", "load", "loaded", "seriesRender", "subtitleRender", "textRender", "titleRender", "tooltipRender"];
var twoWays$5 = [""];
...
var input$i = ["accessibility", "animation", "backwardForecast", "dashArray", "enableTooltip", "fill", "forwardForecast", "intercept", "legendShape", "linearGradient", "marker", "name", "period", "polynomialOrder", "radialGradient", "type", "visible", "width"];
var outputs$n = [];
...
var input$e = ["content", "coordinateUnits", "description", "horizontalAlignment", "region", "verticalAlignment", "x", "xAxisName", "y", "yAxisName"];
var outputs$j = [];
...
var input$c = ["interval", "intervalType", "selected", "text"];
var outputs$h = [];
...
var input$b = ["background", "border", "date", "description", "placeAt", "seriesIndexes", "showOnSeries", "text", "textStyle", "type"];
var outputs$g = [];
...
StockChartComponent.ɵcmp = ɵɵdefineComponent({
  ...
  contentQueries: function StockChartComponent_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
      ɵɵcontentQuery(dirIndex, _c2, 5)(dirIndex, _c3, 5)(dirIndex, StockChartSeriesCollectionDirective, 5)(dirIndex, StockChartAxesDirective, 5)(dirIndex, StockChartRowsDirective, 5)(dirIndex, StockChartAnnotationsDirective, 5)(dirIndex, StockChartSelectedDataIndexesDirective, 5)(dirIndex, StockChartPeriodsDirective, 5)(dirIndex, StockEventsDirective, 5)(dirIndex, StockChartIndicatorsDirective, 5);
    }
    if (rf & 2) {
      let _t;
      ɵɵqueryRefresh(_t = ɵɵloadQuery()) && (ctx.tooltip_template = _t.first);
...
__decorate([Template()], StockChartComponent.prototype, "legendSettings_template", void 0);
...
var input$9 = ["color", "end", "index", "legendImageUrl", "name", "opacity", "shape"];
var outputs$d = [];
...
BulletChartComponent.ɵcmp = ɵɵdefineComponent({
  ...
  contentQueries: function BulletChartComponent_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
      ɵɵcontentQuery(dirIndex, _c2, 5)(dirIndex, BulletRangeCollectionDirective, 5);
    }
    if (rf & 2) {
      let _t;
      ɵɵqueryRefresh(_t = ɵɵloadQuery()) && (ctx.tooltip_template = _t.first);
...
var input$8 = ["animation", "columnFacet", "columnSpacing", "columnWidth", "dataLabel", "dataSource", "emptyPointSettings", "enableTooltip", "fill", "groupName", "legendImageUrl", "legendShape", "name", "opacity", "pointColorMapping", "query", "size", "stackingGroup", "tooltipFormat", "tooltipMappingName", "type", "visible", "xAxisName", "xName", "yAxisName", "yName"];
var outputs$b = [];
...
var inputs$2 = ["axes", "background", "backgroundImage", "border", "columns", "currencyCode", "dataSource", "depth", "description", "enableExport", "enablePersistence", "enableRotation", "enableRtl", "enableSideBySidePlacement", "height", "highlightColor", "highlightMode", "highlightPattern", "isMultiSelect", "isTransposed", "legendSettings", "locale", "margin", "palettes", "perspectiveAngle", "primaryXAxis", "primaryYAxis", "rotation", "rows", "selectedDataIndexes", "selectionMode", "selectionPattern", "series", "subTitle", "subTitleStyle", "theme", "tilt", "title", "titleStyle", "tooltip", "useGroupingSeparator", "wallColor", "wallSize", "width"];
var outputs$6 = ["afterExport", "axisLabelRender", "beforeExport", "beforePrint", "beforeResize", "chart3DMouseClick", "chart3DMouseDown", "chart3DMouseLeave", "chart3DMouseMove", "chart3DMouseUp", "legendClick", "legendRender", "load", "loaded", "pointClick", "pointMove", "pointRender", "resized", "selectionComplete", "seriesRender", "textRender", "tooltipRender", "dataSourceChange"];
...
Chart3DComponent.ɵcmp = ɵɵdefineComponent({
  ...
  contentQueries: function Chart3DComponent_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
      ɵɵcontentQuery(dirIndex, _c2, 5)(dirIndex, Chart3DSeriesCollectionDirective, 5)(dirIndex, Chart3DAxesDirective, 5)(dirIndex, Chart3DRowsDirective, 5)(dirIndex, Chart3DColumnsDirective, 5)(dirIndex, Chart3DSelectedDataIndexesDirective, 5);
    }
    if (rf & 2) {
      let _t;
      ɵɵqueryRefresh(_t = ɵɵloadQuery()) && (ctx.tooltip_template = _t.first);
...
var input$3 = ["animation", "dataLabel", "dataSource", "emptyPointSettings", "enableTooltip", "explode", "explodeAll", "explodeIndex", "explodeOffset", "innerRadius", "legendImageUrl", "legendShape", "name", "opacity", "palettes", "pointColorMapping", "query", "radius", "tooltipMappingName", "visible", "xName", "yName"];
var outputs$5 = [];
...
var inputs$1 = ["background", "backgroundImage", "border", "dataSource", "depth", "enableAnimation", "enableExport", "enablePersistence", "enableRotation", "enableRtl", "height", "highlightColor", "highlightMode", "highlightPattern", "isMultiSelect", "legendSettings", "locale", "margin", "rotation", "selectedDataIndexes", "selectionMode", "selectionPattern", "series", "subTitle", "subTitleStyle", "theme", "tilt", "title", "titleStyle", "tooltip", "useGroupingSeparator", "width"];
var outputs$3 = ["afterExport", "beforeExport", "beforePrint", "beforeResize", "circularChart3DMouseClick", "circularChart3DMouseDown", "circularChart3DMouseLeave", "circularChart3DMouseMove", "circularChart3DMouseUp", "legendClick", "legendRender", "load", "loaded", "pointClick", "pointMove", "pointRender", "resized", "selectionComplete", "seriesRender", "textRender", "tooltipRender", "dataSourceChange"];
...
CircularChart3DComponent.ɵcmp = ɵɵdefineComponent({
  ...
  contentQueries: function CircularChart3DComponent_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
      ɵɵcontentQuery(dirIndex, _c2, 5)(dirIndex, CircularChart3DSeriesCollectionDirective, 5)(dirIndex, CircularChart3DSelectedDataIndexesDirective, 5);
    }
    if (rf & 2) {
      let _t;
      ɵɵqueryRefresh(_t = ɵɵloadQuery()) && (ctx.tooltip_template = _t.first);
...
var input$1 = ["color", "id", "label", "offset"];
var outputs$2 = [];
var SankeyNodeDirective = class extends ComplexBase {
  constructor(viewContainerRef) {
    super();
    this.viewContainerRef = viewContainerRef;
    setValue("currentInstance", this, this.viewContainerRef);
...
SankeyNodeDirective.ɵfac = function SankeyNodeDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || SankeyNodeDirective)(ɵɵdirectiveInject(ViewContainerRef));
};
SankeyNodeDirective.ɵdir = ɵɵdefineDirective({
  type: SankeyNodeDirective,
  selectors: [["e-sankey-node"]],
  inputs: {
    color: "color",
    id: "id",
    label: "label",
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SankeyNodeDirective, [{
    type: Directive,
    args: [{
...
var SankeyNodesCollectionDirective = class extends ArrayBase {
  constructor() {
    super("nodes");
  }
};
SankeyNodesCollectionDirective.ɵfac = function SankeyNodesCollectionDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || SankeyNodesCollectionDirective)();
};
SankeyNodesCollectionDirective.ɵdir = ɵɵdefineDirective({
  type: SankeyNodesCollectionDirective,
  selectors: [["e-sankey-nodes"]],
  contentQueries: function SankeyNodesCollectionDirective_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
      ɵɵcontentQuery(dirIndex, SankeyNodeDirective, 4);
    }
    if (rf & 2) {
      let _t;
      ɵɵqueryRefresh(_t = ɵɵloadQuery()) && (ctx.children = _t);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SankeyNodesCollectionDirective, [{
    type: Directive,
    args: [{
...
var input = ["sourceId", "targetId", "value"];
var outputs$1 = [];
var SankeyLinkDirective = class extends ComplexBase {
  constructor(viewContainerRef) {
    super();
    this.viewContainerRef = viewContainerRef;
    setValue("currentInstance", this, this.viewContainerRef);
...
SankeyLinkDirective.ɵfac = function SankeyLinkDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || SankeyLinkDirective)(ɵɵdirectiveInject(ViewContainerRef));
};
SankeyLinkDirective.ɵdir = ɵɵdefineDirective({
  type: SankeyLinkDirective,
  selectors: [["e-sankey-link"]],
  inputs: {
    sourceId: "sourceId",
    targetId: "targetId",
    value: "value"
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SankeyLinkDirective, [{
    type: Directive,
    args: [{
...
var SankeyLinksCollectionDirective = class extends ArrayBase {
  constructor() {
    super("links");
  }
};
SankeyLinksCollectionDirective.ɵfac = function SankeyLinksCollectionDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || SankeyLinksCollectionDirective)();
};
SankeyLinksCollectionDirective.ɵdir = ɵɵdefineDirective({
  type: SankeyLinksCollectionDirective,
  selectors: [["e-sankey-links"]],
  contentQueries: function SankeyLinksCollectionDirective_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
      ɵɵcontentQuery(dirIndex, SankeyLinkDirective, 4);
    }
    if (rf & 2) {
      let _t;
      ɵɵqueryRefresh(_t = ɵɵloadQuery()) && (ctx.children = _t);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SankeyLinksCollectionDirective, [{
    type: Directive,
    args: [{
...
var inputs = ["accessibility", "allowExport", "animation", "background", "backgroundImage", "border", "enableExport", "enablePersistence", "enableRtl", "focusBorderColor", "focusBorderMargin", "focusBorderWidth", "height", "labelSettings", "legendSettings", "linkStyle", "links", "locale", "margin", "nodeStyle", "nodes", "orientation", "subTitle", "subTitleStyle", "theme", "title", "titleStyle", "tooltip", "width"];
var outputs = ["afterExport", "beforeExport", "beforePrint", "exportCompleted", "labelRendering", "legendItemHover", "legendItemRendering", "linkClick", "linkEnter", "linkLeave", "linkRendering", "load", "loaded", "nodeClick", "nodeEnter", "nodeLeave", "nodeRendering", "sizeChanged", "tooltipRendering"];
var twoWays = [""];
var SankeyComponent = class SankeyComponent2 extends Sankey {
  constructor(ngEle, srenderer, viewContainerRef, injector) {
    super();
    this.ngEle = ngEle;
    this.srenderer = srenderer;
...
SankeyComponent.ɵfac = function SankeyComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || SankeyComponent)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(ViewContainerRef), ɵɵdirectiveInject(Injector));
};
SankeyComponent.ɵcmp = ɵɵdefineComponent({
  type: SankeyComponent,
  selectors: [["ejs-sankey"]],
  contentQueries: function SankeyComponent_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
      ɵɵcontentQuery(dirIndex, _c4, 5)(dirIndex, _c5, 5)(dirIndex, SankeyNodesCollectionDirective, 5)(dirIndex, SankeyLinksCollectionDirective, 5);
    }
    if (rf & 2) {
      let _t;
      ɵɵqueryRefresh(_t = ɵɵloadQuery()) && (ctx.tooltip_sankeyNodeTemplate = _t.first);
      ɵɵqueryRefresh(_t = ɵɵloadQuery()) && (ctx.tooltip_sankeyLinkTemplate = _t.first);
      ɵɵqueryRefresh(_t = ɵɵloadQuery()) && (ctx.childNodes = _t.first);
      ɵɵqueryRefresh(_t = ɵɵloadQuery()) && (ctx.childLinks = _t.first);
    }
  },
  inputs: {
    accessibility: "accessibility",
...
__decorate([Template()], SankeyComponent.prototype, "tooltip_sankeyNodeTemplate", void 0);
__decorate([Template()], SankeyComponent.prototype, "tooltip_sankeyLinkTemplate", void 0);
SankeyComponent = __decorate([ComponentMixins([ComponentBase])], SankeyComponent);
(() => {
...
SankeyModule.ɵfac = function SankeyModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || SankeyModule)();
};
SankeyModule.ɵmod = ɵɵdefineNgModule({
  type: SankeyModule,
  declarations: [SankeyComponent, SankeyNodeDirective, SankeyNodesCollectionDirective, SankeyLinkDirective, SankeyLinksCollectionDirective],
  imports: [CommonModule],
  exports: [SankeyComponent, SankeyNodeDirective, SankeyNodesCollectionDirective, SankeyLinkDirective, SankeyLinksCollectionDirective]
});
...
var SankeyLegendService = {
  provide: "ChartsSankeyLegend",
  useValue: SankeyLegend
};
var SankeyTooltipService = {
  provide: "ChartsSankeyTooltip",
  useValue: SankeyTooltip
};
var SankeyHighlightService = {
  provide: "ChartsSankeyHighlight",
  useValue: SankeyHighlight
};
var SankeyExportService = {
  provide: "ChartsSankeyExport",
  useValue: SankeyExport
};
var SankeyAllModule = class {
};
SankeyAllModule.ɵfac = function SankeyAllModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || SankeyAllModule)();
};
SankeyAllModule.ɵmod = ɵɵdefineNgModule({
  type: SankeyAllModule,
  imports: [CommonModule, SankeyModule],
  exports: [SankeyModule]
});
SankeyAllModule.ɵinj = ɵɵdefineInjector({
  providers: [SankeyLegendService, SankeyTooltipService, SankeyHighlightService, SankeyExportService],
  imports: [[CommonModule, SankeyModule], SankeyModule]
});
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SankeyAllModule, [{
    type: NgModule,
    args: [{
      imports: [CommonModule, SankeyModule],
      exports: [SankeyModule],
